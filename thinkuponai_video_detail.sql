...
CREATE TABLE `video_detail` (
  ...
  `No_of_comments` int DEFAULT NULL,
...
INSERT INTO `video_detail` VALUES (6,'Psychology',405),(3,'Entertainment',137785),(8,'Brand sponsorship',53),(2,'Psychology',297),(1,'Advice',101),(4,'Culture',1467),(5,'Philosophy',1281),(7,'Philosophy',1193);
